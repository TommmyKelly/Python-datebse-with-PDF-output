...
inset_products_data = '''INSERT INTO products (product_name, unit_cost) VALUES (?,?)'''

insert_sales_date = '''INSERT INTO sales (sale_date, customer_id, product_id, quantity, unit_price, total_price) VALUES 
                       (?, ?, ?, ?, ?, ?)'''
insert_customers_data = '''INSERT INTO customers (first_name, last_name, email, phone) VALUES (?, ?, ?, ?)'''

products = [('Product A', 50.00), ('Product B', 25.00), ('Product C', 75.00), ('Product D', 40.00),
            ('Product E', 60.00)]
...
# Define the start and end date for generating sales data
...
with sqlite3.connect('sales.db') as conn:
    ...
    for product in products:
        conn.execute(inset_products_data, product)
    ...
    for i in range(1000):
        ...
        conn.execute(insert_sales_date, (sale_date, customer_id, product_id, quantity, unit_price, total_price))
